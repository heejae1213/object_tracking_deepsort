...
#parser.add_argument('--det_path', help="Path to detection file", default="det/21h_07m_28s.txt")
...
if __name__ == '__main__':
	...
	det_name = "det/det_"+os.path.splitext(base)[0]+".txt"
	filename = det_name
	...
	out = cv2.VideoWriter('result.mp4',fourcc, fps, (int(width),int(height)))
